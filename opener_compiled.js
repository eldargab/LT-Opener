...
lt.plugins.opener.sh = (function sh(p__8558){var vec__8560 = p__8558;var command = cljs.core.nth.call(null,vec__8560,0,null);var args = cljs.core.nthnext.call(null,vec__8560,1);var proc = lt.plugins.opener.spawn.call(null,command,cljs.core.to_array.call(null,args));var stderr = proc.stderr;var stdout = proc.stdout;var err = cljs.core.atom.call(null,"");var out = cljs.core.atom.call(null,"");stderr.setEncoding("utf8");
stdout.setEncoding("utf8");
stdout.on("data",(function (s){return cljs.core.swap_BANG_.call(null,out,(function (p1__8556_SHARP_){return [cljs.core.str(p1__8556_SHARP_),cljs.core.str(s)].join('');
}));
}));
stderr.on("data",(function (s){return cljs.core.swap_BANG_.call(null,err,(function (p1__8557_SHARP_){return [cljs.core.str(p1__8557_SHARP_),cljs.core.str(s)].join('');
}));
}));
...
lt.plugins.opener.__BEH__set_shell_command = (function __BEH__set_shell_command(this$,type,os,command){return lt.object.update_BANG_.call(null,this$,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [type], null),(function (p1__8561_SHARP_){return cljs.core.assoc.call(null,p1__8561_SHARP_,os,command);
}));
});
...
lt.plugins.opener.__GT_command = (function __GT_command(type,path){return cljs.core.map.call(null,(function (p1__8562_SHARP_){return clojure.string.replace.call(null,p1__8562_SHARP_,"{{path}}",path);
...
{var path = lt.plugins.opener.active_path.call(null);return cljs.core.first.call(null,cljs.core.filter.call(null,(function (p1__8563_SHARP_){return path.startsWith(p1__8563_SHARP_);
}),dirs));
}
})());
});
